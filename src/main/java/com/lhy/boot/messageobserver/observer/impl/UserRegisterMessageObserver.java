...
@Observer(value = Action.userRegister, async = true)
@Component
public class UserRegisterMessageObserver implements MessageObserver {
	...
	public void update(MessageObservable o, Message message) {
		...
		logger.info("UserRegisterMessageObserver:" + message.getData());
	}
